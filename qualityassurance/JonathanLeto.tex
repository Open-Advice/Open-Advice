...
git ninja and avid bicyclist living in Portland, Oregon. Duke is a core developer of Parrot Virtual Machine, board member of the Parrot Foundation and community manager. He helped create the PDX Hackathon user group and has been listed as one of the most influential coders in Portland, OR according to Github statistics.
\newline
...
enjoys discovering wheels within wheels.}\todo{can we shorten this a bit?}
...
many parts work in unison. A great example of an integration test is test-driving a car. You are not checking the air pressure, or measuring voltage of the spark plugs. You are making sure the vehicle works as a whole.
