\chapter{Where Upstream and Downstream Meet -- Vincent Untz}
...
However, he finds it simpler to declare he is a "touche-à-tout", working on
...
software to us. It's here, and we can simply enjoy it.
...
of their favorite applciations) and for upstream (who can help build a stronger
...
suggesting that we, Free Software community, should slowly migrate the
