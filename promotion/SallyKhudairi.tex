...
how the <now-deprecated-markup>\todo{fix} tag got on our site. And no, it was not <blink>\todo{fix} \dots
...
not what they were way back when\todo{then?}; distraction/failure is just a click away.
