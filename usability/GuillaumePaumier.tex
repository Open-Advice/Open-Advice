...
\todo{add some headddings to break it up?}
\todo{Often uses “you” but it means both the user and “developers”. To confuse this, the author first refers to developers by name (e.g. “developers”) but then switches person reference and refers to developers as “you”. This is very confusing, especially if the reader is NOT a developer. Needs to rewrite all references of you to developer or SPECIFICALLY call you “If you were a developer, imagine...”}
...
Multimedia Usability\todo{Is Multimedia Usability a Wikipedia project? Should specify otherwise people wont know what it is.}, he notably conducted user research to design a new media
...
issues recruiting new participants\todo{Suggestion: change “recruiting new participants” to “recruiting new contributors”} in the last few years, in part because of its
...
Wikipedia and its sister projects\todo{examples of sister projects} are powered by a wiki engine called MediaWiki
...
It is particularly difficult for the developer to sit in the user's chair. For one
