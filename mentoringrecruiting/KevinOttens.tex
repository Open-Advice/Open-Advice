...
attract new contributors out of universities simply because of \todo{whose inaction, the community members or the new contributors or students?}their inaction?
...
discourse to them; for instance, the students we trained are all part of the so-called Y generation which exhibits fairly different traits regarding leadership, loyalty and trust than our generation.\todo{you don't know who our is in this context, I'm an X-gen, is that the gen you mean?}
...
the conclusion.\todo{I would remove this first sentence.} At the end of the day why would you go through all the effort
