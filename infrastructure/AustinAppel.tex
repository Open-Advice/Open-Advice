...
The problem is that people have of backups is one of a purely defensive posture.\todo{Something is strange in this sentence.}
...
paragraph.\todo{write the bla bla ;-)}
