...
Links to example prospectus’ are below. They are all for big conferences, so YMMV\todo{known acronym for the readers?}. I have made a prospectus before that only had one option for sponsorship, and whose benefits were: send one attendee from your company, and recognition by the organizer to the attendees. 
\begin{itemize}
