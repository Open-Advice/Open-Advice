\chapter{What I would do different next time or Underestimating the value of an
...
But, KDE contributors are not only motivated by fun to join KDE. It is also the
