...
\chapter{Carlo Daffara}{Free and Open Source-Based Business Models}
\todo{decide between floss foss fs and os and stick to it}
...
incentives).\todo{this sentence needs work} Is it possible to do better? Is there a reality behind the idea of
...
The large share of ``internal'' Free Software deployments explains why some of the economic benefits are not perceived directly in the business service market.
...
project maintainer: \todo{rewrite to not need the graph - image will not look good in print} The graph shows the amount of contributions
